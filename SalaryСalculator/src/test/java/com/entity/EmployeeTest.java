...
class EmployeeTest {
    ...
    @BeforeEach
    void init(){
         natasha1 = new Employee("Natasha", new Date(1284237214), new Date(1599856414));
         misha1 = new Employee("Misha", new Date(1315773214), new Date(1442003614));

         natasha2 = new Employee("Natasha", new Date(1284237214), new Date(1599856414));
         misha2 = new Employee("Misha", new Date(1315773214), new Date(1442003614));
    }
